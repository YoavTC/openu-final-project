...
public class GenerateEnemyScriptableObjects : Editor
{
    [MenuItem("Automation/Generate Enemy Items")]
    static void GenerateItems()
    {
        GenerateEnemyScriptableObjectsWindow.OpenWindow();
    }
}

public class GenerateEnemyScriptableObjectsWindow : EditorWindow
{
    ...
    public static void OpenWindow()
    {
        ...
        GetWindow<GenerateEnemyScriptableObjectsWindow>().Close();
        
        GenerateEnemyScriptableObjectsWindow window = GetWindowWithRect<GenerateEnemyScriptableObjectsWindow>(
            windowRect,
            focusedWindow,
            "Generate Enemy Items Window",
            true);
    ...
    private void Generate()
    {
        ...
        {
            EnemySettings newEnemySettings = CreateInstance<EnemySettings>();
            newEnemySettings.sprite = sprite;
            newEnemySettings.name = sprite.name;
            ...
            AssetDatabase.CreateAsset(newEnemySettings, path.Substring(startPathIndex) + "/" + newEnemySettings.name + ".asset");
